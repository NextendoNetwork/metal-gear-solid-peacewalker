...
// Nextendo NPLN Server — METAL GEAR SOLID: Peace Walker (Title ID: 0100C6F01C4F8000, Tenant: t-4f53195c-lp1)
//
// Standalone NPLN backend, forked from the Super Mario Bros. Wonder server.
...
func main() {
	...
	log.Printf("================================================================")
	log.Printf(" Nextendo NPLN Server — METAL GEAR SOLID: Peace Walker [%s]", nplnAppID)
	log.Printf(" Tenant ID: %s | TLS host: %s", nplnTenantID, wonderTLSHostname)
	log.Printf("================================================================")
