...
var (
	nplnAppID    = envOr("NPLN_APP_ID", "0100C6F01C4F8000")  // METAL GEAR SOLID: Peace Walker - Master Collection Version
	nplnTenantID = envOr("NPLN_TENANT_ID", "t-4f53195c-lp1") // Peace Walker tenant (4f53195c)
...
func nplnSigningKey() (*ecdsa.PrivateKey, string) {
	jwtOnce.Do(func() {
		jwtKID = strings.TrimSuffix(strings.TrimPrefix(nplnTenantID, "t-"), "-lp1") + "-npln-4992-80bf-5f289ebbf566"
